...
function load_js()
{
  ...
  // Skin Nutrition
  elseif (is_page_template('skin-nutrition.php') || is_page_template('ingredients.php') || is_page_template('synergy.php') || is_page_template('additive-free.php') || is_page_template('fresh-freeze.php')) {
